...
select avg(salary_1.monthly_salary) as avg_salary from salary_1
	join employee_salary
	on salary_1.id = employee_salary.salary_id 
	join employees
	on employees.id = employee_salary.employee_id
...
select sum(salary_1.monthly_salary) as sum_salary from salary_1
	join employee_salary
	on salary_1.id = employee_salary.salary_id 
	join employees
	on employees.id = employee_salary.employee_id
...
select min(salary_1.monthly_salary) as min_salary from salary_1
	join employee_salary
	on salary_1.id = employee_salary.salary_id 
	join employees
	on employees.id = employee_salary.employee_id
...
select max(salary_1.monthly_salary) as max_salary from salary_1
	join employee_salary
	on salary_1.id = employee_salary.salary_id 
	join employees
	on employees.id = employee_salary.employee_id
